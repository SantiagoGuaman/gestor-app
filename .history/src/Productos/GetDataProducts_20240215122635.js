...
function GetDataProducts() {
    ...
    const handleEdit = (producto) => {
        ...
        setEditProducto({
            ...
            categoria: producto.categoria, // Suponiendo que producto.categoria es el ID de la categoría
            proveedor: producto.proveedor // Suponiendo que producto.proveedor es el ID del proveedor
        });
    };
