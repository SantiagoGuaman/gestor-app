        ...
        <div className='container text-center mt-5'>
            ...
            <div className='card-body'>
                                        ...
                                        <td>
                                            {editCategoriaId === categoria.id_categoria ? (
                                                ...
                                                <>
                                                    ...
                                                    <button className='btn btn-danger btn-sm' onClick={() => handleDelete(categoria.id_categoria)}>Eliminar</button>
                                                </>
                                            )}
                                        </td>
                                    </tr>
                ...
                <div>
                    ...
                    <button className='btn btn-primary btn-sm' onClick={() => setCreateModalOpen(true)}>Crear</button>
                    {isCreateModalOpen && (
